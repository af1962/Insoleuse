...
char texte[16];           // Tableau de caractère pour affiche de texte dans Nextion
...
void bpStartPushCallback(void* ptr)
{
    ...
    {
        nexprogress.setImgbpic(11);
        nexprogress.setImgppic(12);
    }
    else
    {
        nexprogress.setImgbpic(12);
        nexprogress.setImgppic(13);
    }
    MarcheUV();
    Fin("Fin");
}
...
void bpRetroPushCallback(void* ptr)
{
    ...
    lum.RetroEclairage(bpRetro.getValue(&dual_stateRetroEclairage));
}
